...
int main()
{
    ...
    cout << "How many people have you recently served?" << endl;
    cin >> customerTotal;
    ...
    cout << "Of the " << customerTotal << " people served, " << round((customerTotal * (percentageOfBuyers / 100))) << " of them buy at least one energy drink every week." << endl; // Does the math to show the amount of people who have bought a drink in the past week.
